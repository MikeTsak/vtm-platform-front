...
export const DISCIPLINES = {
      ...
      2: [
        {
          ...
          dice_pool: 'None (Famulus tests when target location unknown)',
          opposing_pool: 'None',
          notes:
            "Famulus rolls Resolve + Streetwise/Survival (diff 2) if target’s location is unknown; Intelligence + Streetwise/Survival if the target is actively hiding.",
        ...
        },
        {
          ...
          dice_pool: 'None',
          opposing_pool: 'None',
          notes: "Channel their Blood to prevent the Beast from awakening. Can also turn one die's failure into a success with Frenzy tests.",
          source: 'Live from the Succubus Club p.27',
        },
        {
          id: 'tracing_the_blood',
          name: 'Tracing the Blood',
          cost: '1 Rouse Check',
          duration: 'One scene.',
          dice_pool: 'Resolve + Animalism',
          opposing_pool: 'None',
          notes: 'Understand how others Rouse the Blood detecting Blood Surges, Blush of Life, or Disciplines. Must be in sensory range. Margin determines amount of info obtained.',
          source: 'Courts of the Damned p.214',
        },
      ],
      3: [
        {
        ...
        },
        {
          ...
          notes:
            'Marks a target; they take margin as penalty to non-Physical Skill pools; easier to track.',
          source: 'Players Guide p.69',
        },
        {
          id: 'quell_the_beast',
    ...
    levels: {
      1: [
        ...
        },
        {
          ...
          opposing_pool: 'None (vs Obfuscate: Wits + Obfuscate)',
      ...
      2: [
        ...
        },
        {
          ...
          dice_pool: 'Resolve + Auspex',
          opposing_pool: 'None (victim may roll Wits + Awareness once to glimpse pursuer)',
      ...
      3: [
        ...
        },
        {
          ...
          name: 'Read the Room',
          cost: '1 Rouse',
          duration: 'Instantaneous or one scene on Critical Win.',
          dice_pool: 'Intelligence + Auspex',
          opposing_pool: 'None',
    ...
    levels: {
      ...
      4: [
        ...
        },
        {
          ...
          cost: '1 Rouse',
          prerequisite: 'Transitive Bond',
          duration: 'None',
          dice_pool: 'None',
          opposing_pool: 'None',
          notes: 'Creates a blood bond between two targets that drank the user\'s Blood in the same scene.',
          source: 'Children of the Blood p.75',
        },
      ],
      5: [
        {
    ...
    levels: {
      ...
      4: [
        ...
        },
        {
          ...
          dice_pool: 'None',
          opposing_pool: 'None',
          notes: 'While using Blink, make an additional Rouse Check to pass through areas of sunlight or fire without damage or their effect. Does not negate other impacts from daylight or fire.',
          source: 'Live from the Succubus Club p.27',
        },
      ],
      5: [
  ...
  'Dominate': {
    ...
    notes_general:
      'Most uses require eye contact and spoken commands the victim understands. Victims cannot be ordered to directly cause serious self-harm without Terminal Decree. Once Dominate totally fails against a target, further attempts against them fail for the rest of the story.',
    levels: {
      1: [
        {
          id: 'cloud_memory',
        ...
        },
        {
          ...
          notes:
            'Issue a simple command. No roll vs unprepared mortals; mortals already Dominated this scene or acting against their nature may roll to resist.',
          source: 'Corebook p.256',
        },
        {
          id: 'slavish_devotion',
          ...
          opposing_pool: 'None',
          notes:
            "Victims already under your Dominate resist third-party Dominate: attackers take a dice penalty equal to the victim’s Fortitude. (Errata)",
      ...
      2: [
        {
          ...
          opposing_pool: 'Intelligence + Resolve',
          notes:
            'Issue complex commands. No roll vs unprepared mortals; if against their nature they may roll to resist.',
          source: 'Corebook p.256',
        },
        {
          id: 'dementation',
        ...
        },
        {
          ...
          opposing_pool: 'None',
          notes:
            'While Blood-Bonded, defiance is harder. On a total fail of defiance rolls, the bond does not weaken that month.',
        ...
        },
        {
          ...
          notes:
            'Target cannot speak, write, or gesture to express. No activation test vs mortals.',
      ...
      3: [
        {
          ...
          opposing_pool: 'Intelligence + Resolve',
          notes:
            'Rewrite memories; each point of margin allows one additional memory to be altered.',
        ...
        },
        {
          ...
          opposing_pool: 'None',
          notes:
            'Implant a standing suggestion/order that never expires until completed. One directive per target at a time.',
          source: 'Corebook p.257',
        },
        {
          id: 'chain_of_command',
          ...
          cost: '1 Rouse Check',
          prerequisite: 'Mesmerize',
          duration: 'Until the command is carried out.',
          dice_pool: 'Manipulation + Dominate',
          opposing_pool: 'Intelligence + Resolve',
          notes: 'Force the victim to issue the given command to their inferiors or anyone they interact with if their inferiors are unknown.',
          source: 'Courts of the Damned p.214',
        },
      ],
      4: [
        {
          ...
          dice_pool: 'Manipulation + Dominate',
          opposing_pool: 'Resolve + Occult',
          notes:
            'Urge a descendant to act, even against their opinion. Target gains +1 die to resist per generation separating you. (Errata)',
        ...
        },
        {
          ...
          opposing_pool: 'Composure + Resolve',
          notes:
            'Temporarily alter personality/opinion. No test vs unprepared mortals unless it opposes core beliefs.',
        ...
        },
        {
          ...
          opposing_pool: 'None',
          notes:
            'Victims believe Dominated actions were their own idea; if pressed, they may test to question their actions.',
          source: 'Corebook p.257',
        },
        {
          id: 'tabula_rasa',
          ...
          opposing_pool: 'Composure + Resolve',
          notes:
            "Erase identity-level memories. Often followed by lies and Path indoctrination (Sabbat practice).",
          source: 'Sabbat p.47',
        },
      ],
      5: [
        {
          ...
          opposing_pool: 'Intelligence + Resolve',
          notes:
            'Erase weeks of memory. Unprepared mortals cannot resist. With a verbal command only memories around the spoken subject are erased.',
          source: 'Gehenna War p.46',
        },
        {
          ...
          opposing_pool: 'None',
          notes:
            'Apply a Dominate power to multiple targets who see your eyes. Roll once vs the strongest target.',
          source: 'Corebook p.257',
        },
        {
          id: 'terminal_decree',
          ...
          opposing_pool: 'None',
          notes:
            'Allows commands that override self-preservation. Such commands are always resisted (never auto-succeed).',
          source: 'Corebook p.257',
        },
      ],
    },
    ...
    levels: {
      ...
      2: [
        ...
        },
        {
          ...
          cost: 'None (aside from Rouse to donate blood)',
          amalgam: 'Auspex ●',
          duration: 'Passive',
          dice_pool: 'None',
          opposing_pool: 'None',
        ...
        },
        {
          ...
          dice_pool: 'None',
          opposing_pool: 'None',
          notes: 'Replace one damage done to your Willpower track to Superficial damage. It can only be used once per scene.',
          source: 'Courts of the Damned p.215',
        },
      ],
      3: [
        {
      ...
      5: [
        ...
        },
        {
          ...
          dice_pool: 'None',
          opposing_pool: 'None',
          notes: 'If a vampire were to suffer Aggravated damage equal to or higher than their remaining Health boxes that would result in Final Death, they drop to Torpor instead. This costs no actions but the vampire must have a Blood Potency of at least 2.',
          source: 'Children of the Blood p.75',
        },
      ],
    },
    ...
    levels: {
      1: [
        ...
        },
        {
          ...
          source: 'Live from the Succubus Club p.28',
        },
      ],
      2: [
        {
    ...
    levels: {
      ...
      3: [
        ...
        },
        {
          ...
          dice_pool: 'None',
          opposing_pool: 'None',
          notes: 'Treat Potence rating as two levels higher when using Potence powers. This can take the relative discipline above the limit of 5. But when a critical or failure is rolled, take Aggravated Damage.',
          source: 'Tattered Façade p.103',
        },
        {
          id: 'spark_of_rage',
          name: 'Spark of Rage',
          ...
          amalgam: 'Presence ●●●',
          duration: 'One scene',
          dice_pool: 'None (vs vampires: Manipulation + Potence)',
          opposing_pool: 'None (vs vampires: Intelligence + Composure)',
    ...
    levels: {
      ...
      2: [
        ...
        },
        {
          ...
          cost: '1 Rouse',
          duration: 'One scene, or until target is within 3 meters',
          dice_pool: 'Charisma + Leadership',
          opposing_pool: 'Composure + Resolve',
          notes: 'Instill intense curiosity to compel a target to approach. Automatically works on mortals. Target will not risk danger or immediately drop everything. Cannot be used in a fight.',
          source: 'Courts of the Damned p.215',
        },
      ],
      3: [
        ...
        },
        {
          ...
          cost: '1 Rouse',
          amalgam: 'Auspex ●●',
          duration: 'Until sunset (vampire), 3 nights (victim)',
          dice_pool: 'Composure + Auspex',
          opposing_pool: 'None',
          notes: 'Leech the passion from a mortal target, gaining the benefits of Humanity 10 temporarily. Can only be gained once per night.',
          source: 'Tattered Façade p.104',
        },
        {
          id: 'thrown_voice',
          name: 'Thrown Voice',
        ...
        },
        {
          ...
          dice_pool: 'Composure + Presence',
          opposing_pool: 'None',
          notes: 'After interacting with a crowd, inhale their energy to experience a unique Resonance (usually intense, can be acute on a critical).',
          source: 'Live from the Succubus Club p.28',
        },
      ],
      4: [
        {
          ...
          dice_pool: 'Manipulation + Presence',
          opposing_pool: 'Composure + Resolve',
          notes: 'Boost a victim\'s current desire, seeking only to satisfy it. Inflicts the Need Compulsion on the victim.',
          source: 'Tattered Façade p.104',
        },
        {
    ...
    levels: {
      1: [
        ...
        },
        {
          id: 'squirm',
          name: 'Squirm',
          cost: 'Free or 1 Rouse',
          duration: 'As long as desired',
          dice_pool: 'None',
          opposing_pool: 'None',
          notes: 'Turn flesh and bones rubbery, squeezing through tight spaces. With a Rouse check, fit into spaces down to two inches in diameter.',
          source: 'Tattered Façade p.105',
        },
        {
      ...
      3: [
        ...
        },
        {
          ...
          cost: '1 Rouse',
          amalgam: 'Oblivion ●●',
          duration: 'Until ended by user, waking from Torpor, or sunrise',
          dice_pool: 'None',
          opposing_pool: 'None',
          notes: 'Take on the appearance of a corpse. Unable to move or communicate; takes damage only if it deals Aggravated damage. Disciplines usable at ST discretion.',
          source: 'Live from the Succubus Club p.28',
        },
      ],
      4: [
      ...
      5: [
        ...
        },
        {
          ...
          cost: 'None (pay Shapechange costs as normal)',
          prerequisite: 'Shapechange',
        ...
        },
        {
          ...
          dice_pool: 'None',
          opposing_pool: 'None',
          notes: 'Shapechange into a swarm of insects/reptiles/vermin. Can attack individuals equal to Blood Potency per turn.',
          source: 'Tattered Façade p.106',
        },
        {
          id: 'face_of_the_victim',
          name: 'Face of the Victim',
          cost: '1 Rouse',
          prerequisite: 'Vicissitude',
          duration: 'Until Hunger 5 or reusing power',
          dice_pool: 'None',
          opposing_pool: 'None',
          notes: 'Assume the shape of someone you last fed from. Must be activated in the same scene you slaked at least 1 Hunger from them.',
          source: 'Live from the Succubus Club p.28',
        },
      ],
    },
...
function p(name) {
  return [
    ...
    { id: `${slug(name)}_power_b`, name: `${name} Power B` },
    { id: `${slug(name)}_power_c`, name: `${name} Power C` },
  ];
}
