...
export const MERITS_AND_FLAWS = {
  ...
  'Looks': {
    blurb:
      'Related to appearance, whether supernaturally influenced or not.  (Source: Vampire: The Masquerade Corebook, page 179)',
    merits: [
      {
  ...
  'Caitiff': {
    ...
    merits: [
      ...
      },
      {
        ...
        dots: '•••',
        description:
          'Allied local coterie of 3 to 5 thin-bloods (treat as Allies). Incompatible with Liquidator.',
        restrictions: 'Caitiff only',
      },
    ],
    flaws: [
  ...
  'Thin-blood': {
    ...
    merits: [
      { id: idFor('Thin-blood', 'Anarch Comrades'), name: 'Anarch Comrades', dots: 'Thin-blood', description: 'Acts as 1-dot Anarch Mawla.' },
      { id: idFor('Thin-blood', 'Camarilla Contact'), name: 'Camarilla Contact', dots: 'Thin-blood', description: 'Acts as 1-dot Camarilla Mawla.' },
      { id: idFor('Thin-blood', 'Catenating Blood'), name: 'Catenating Blood', dots: 'Thin-blood', description: 'Can create Blood Bonds and embrace thin-bloods.' },
      { id: idFor('Thin-blood', 'Day Drinker'), name: 'Day Drinker', dots: 'Thin-blood', description: 'Walk in the sun; halves Health tracker; removes vampiric abilities in sunlight.' },
      { id: idFor('Thin-blood', 'Discipline Affinity'), name: 'Discipline Affinity', dots: 'Thin-blood', description: 'Natural knack for one Discipline; gain 1 dot; retain extra levels at out-of-clan costs.' },
      { id: idFor('Thin-blood', 'Lifelike'), name: 'Lifelike', dots: 'Thin-blood', description: 'Heartbeat, can eat food, enjoy sex; most medical checks pass at night.' },
      { id: idFor('Thin-blood', 'Thin-blood Alchemist'), name: 'Thin-blood Alchemist', dots: 'Thin-blood', description: 'Gain 1 dot and 1 formula of Thin-blood Alchemy.' },
      { id: idFor('Thin-blood', 'Vampiric Resilience'), name: 'Vampiric Resilience', dots: 'Thin-blood', description: 'Take damage like a full vampire.' },
      { id: idFor('Thin-blood', 'Abhorrent Blood'), name: 'Abhorrent Blood', dots: 'Thin-blood', description: 'Vampires must spend 2 WP each turn to drink from you (mortals/TBA unaffected). (Source: Vampire: The Masquerade Players Guide, page 135)' },
      { id: idFor('Thin-blood', 'Faith-Proof'), name: 'Faith-Proof', dots: 'Thin-blood', description: 'Too close to mortality for True Faith to affect you. (Source: Vampire: The Masquerade Players Guide, page 135)' },
      { id: idFor('Thin-blood', 'Low Appetite'), name: 'Low Appetite', dots: 'Thin-blood', description: 'At sunset with Hunger 0 to 1, roll 2 dice for Rouse and take the highest. (Source: Vampire: The Masquerade Players Guide, page 135)' },
      { id: idFor('Thin-blood', 'Lucid Dreamer'), name: 'Lucid Dreamer', dots: 'Thin-blood', description: 'Once/session receive a clue from prior night or a hint about the story. (Source: Vampire: The Masquerade Players Guide, page 135)' },
      { id: idFor('Thin-blood', "Mortality's Mien"), name: "Mortality's Mien", dots: 'Thin-blood', description: "Auras don't reveal vampiric nature; +2 dice to appear mortal via other methods. (Source: Vampire: The Masquerade Players Guide, page 135)" },
      { id: idFor('Thin-blood', 'Swift Feeder'), name: 'Swift Feeder', dots: 'Thin-blood', description: 'Slake 1 Hunger in a turn and lick closed once/scene. (Source: Vampire: The Masquerade Players Guide, page 135)' },
    ],
    flaws: [
      { id: idFor('Thin-blood', 'Shunned by the Anarchs'), name: 'Shunned by the Anarchs', dots: 'Thin-blood', description: 'Anarchs avoid you; more likely to throw you to Camarilla.' },
      { id: idFor('Thin-blood', 'Branded by the Camarilla'), name: 'Branded by the Camarilla', dots: 'Thin-blood', description: 'Unhealable painful brand; can still take Camarilla Contact.' },
      { id: idFor('Thin-blood', 'Bestial Temper'), name: 'Bestial Temper', dots: 'Thin-blood', description: 'Frenzy as per full vampire rules.' },
      { id: idFor('Thin-blood', 'Clan Curse'), name: 'Clan Curse', dots: 'Thin-blood', description: 'Gain a clan bane (Bane Severity 1); restricted options if certain merits taken.' },
      { id: idFor('Thin-blood', 'Vitae Dependency'), name: 'Vitae Dependency', dots: 'Thin-blood', description: 'Must slake 1 Hunger of vampire vitae each week or lose all vampiric powers.' },
      { id: idFor('Thin-blood', 'Dead Flesh'), name: 'Dead Flesh', dots: 'Thin-blood', description: 'Medical inspections report deceased; −1 die to face-to-face Social vs mortals. (Incompatible with Lifelike.)' },
      { id: idFor('Thin-blood', 'Baby Teeth'), name: 'Baby Teeth', dots: 'Thin-blood', description: 'Fangs never developed or are too dull to feed.' },
      { id: idFor('Thin-blood', 'Mortal Frailty'), name: 'Mortal Frailty', dots: 'Thin-blood', description: 'Mend like a mortal; cannot rouse the blood. (Incompatible with Vampiric Resilience.)' },
      { id: idFor('Thin-blood', 'Heliophobia'), name: 'Heliophobia', dots: 'Thin-blood', description: 'Fear sunlight like full vampire; terror Frenzy from sunlight.' },
      { id: idFor('Thin-blood', 'Night Terrors'), name: 'Night Terrors', dots: 'Thin-blood', description: 'Once/session suffer −1 die for all actions for rest of scene.' },
      { id: idFor('Thin-blood', 'Plague Bearers'), name: 'Plague Bearers', dots: 'Thin-blood', description: 'Susceptible to mortal illness; risk on every feed; mortal meds fail.' },
      { id: idFor('Thin-blood', 'Sloppy Drinker'), name: 'Sloppy Drinker', dots: 'Thin-blood', description: 'Dex + Medicine vs Diff = Hunger slaked; fail leaves ragged wound (Masquerade risk).' },
      { id: idFor('Thin-blood', 'Sun-Faded'), name: 'Sun-Faded', dots: 'Thin-blood', description: 'Alchemy/Disciplines unusable in sunlight; indoors by day at −2 dice if away from sunlight.' },
      { id: idFor('Thin-blood', 'Supernatural Tell'), name: 'Supernatural Tell', dots: 'Thin-blood', description: 'Obvious to supernaturals; −2 dice to Stealth vs them.' },
      { id: idFor('Thin-blood', 'Twilight Presence'), name: 'Twilight Presence', dots: 'Thin-blood', description: 'Mortals avoid you; −1 die to Social pools vs others (not thin-bloods).' },
      { id: idFor('Thin-blood', 'Unending Hunger'), name: 'Unending Hunger', dots: 'Thin-blood', description: 'When feeding this scene, slake 1 fewer (once per scene).' },
    ],
  },
