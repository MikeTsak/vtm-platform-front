...
export default function Register() {
  ...
  return (
    <div className={`${styles['login-page']} ${styles['vamp-bg']}`}>
      ...
      <main>
        <form onSubmit={submit} className={styles['login-card']} aria-labelledby="registerTitle">
          <h2 id="registerTitle" className={styles['card-title']}>Register</h2>
          ...
          <button className={styles.cta} type="submit">Join the Court</button>

          <p className={styles.muted}>
            Have an account? <Link to="/login" className={styles.link}>Return to the Gates</Link>
          </p>
        </form>
      </main>
    </div>
